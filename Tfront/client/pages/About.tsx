...
export default function About() {
  const teamMembers = [
    {
      name: "Stephen Kwaku Odikro",
      role: "Founder & CEO",
      image: "/stephen-ceo.jpg.jpg",
      bio: "With deep roots in Ghana's events and tourism industry, Stephen founded Tales and Trails Ghana in 2021 to share his passion for Ghana's rich culture and heritage with the world."
    },
    {
      name: "Henry Hayford",
      role: "Head of Operations",
      image: "/Henry Hayford.jpg",
      bio: "Henry ensures every tour runs smoothly. His attention to detail and customer service excellence makes every Ghana adventure unforgettable."
    },
    {
      name: "William Yarquah",
      role: "Senior Tour Guide",
      image: "/bassy pick.jpg",
      bio: "A certified guide with deep knowledge of Ghana's history and culture. William brings stories to life with his engaging storytelling and warm personality."
    },
    {
      name: "Ama Darko",
  ...
  const achievements = [
    {
      ...
      description: "250 local campers and 40+ international travelers"
    },
    {
      icon: MapPin,
      number: "15+",
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  ...
                  with travelers from around the world. Founded in 2021 by Stephen Kwaku Odikro, a passionate Ghanaian with 
                  deep roots in the events and tourism industry, our company has grown from humble beginnings to become one of 
                  Ghana's most trusted tour operators.
                </p>
                <p>
                  What started as a camping event has evolved into a comprehensive tourism company 
                ...
                <p>
                  Today, we're proud to have facilitated incredible journeys for over 250 local campers and 40 travelers, 
                  each leaving with not just memories, but a deeper appreciation for Ghana's vibrant culture, complex history, 
