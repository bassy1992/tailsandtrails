...
class BookingAdmin(admin.ModelAdmin):
    list_display = (
        'booking_reference', 'destination', 'user', 'booking_type', 
        'participants', 'total_amount', 'booking_date', 'status', 'created_at'
    )
    list_filter = ('booking_type', 'status', 'booking_date', 'created_at')
    ...
    fieldsets = (
        ('Booking Information', {
            'fields': ('booking_reference', 'destination', 'user', 'booking_type', 'participants')
        }),
        ('Financial', {
            'fields': ('total_amount',)
        }),
